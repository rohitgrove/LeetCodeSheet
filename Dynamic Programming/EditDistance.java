public class EditDistance {
    ...
    public static int minDistance(String word1, String word2) {
        // int idx1 = 0;
        // int idx2 = 0;
        // int ans = solveUsingRec(word1, word2, idx1, idx2);
        // int dp[][] = new int[word1.length() + 1][word2.length() + 1];
        // for (int[] row : dp) {
        // Arrays.fill(row, -1);
        // }
        // int ans = solveUsingMemo(word1, word2, idx1, idx2, dp);
        int ans = solveUsingTabulationSO1(word1, word2);
        return ans;
    }
