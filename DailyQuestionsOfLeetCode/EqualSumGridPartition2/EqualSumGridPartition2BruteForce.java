...
public class EqualSumGridPartition2BruteForce {
    public static boolean check(HashMap<Long, Integer> mp, int[][] grid, int r1, int r2, int c1, int c2, long diff) {
        int rows = r2 - r1 + 1;
        int cols = c2 - c1 + 1;
    ...
    public static void main(String[] args) {
        ...
        System.out.println(canPartitionGrid(grid3));
    }
}
