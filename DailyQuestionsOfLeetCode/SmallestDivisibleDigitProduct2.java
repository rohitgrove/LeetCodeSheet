...
public class SmallestDivisibleDigitProduct2 {
    ...
    static int maxPrime = primes[primes.length - 1];
    ...
    public static String smallestNumber(String num, long t) {
        ...
        for (int last = numLength - 1,
                end = Math.min(firstZeroIndexFromLeft, last); end >= 0; end--) {
    ...
    public static void logNum(int[] primeCount, int num, int value) {
        if (num < '2') {
            return;
        }
    ...
    public static int getMinLength(int[] primeCount) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(smallestNumber("11111", 26));
    }
}
